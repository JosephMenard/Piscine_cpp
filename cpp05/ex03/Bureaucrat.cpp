...
void Bureaucrat::executeFrom(AForm const& obj)
{
    try
    {
        obj.execute(*this);
        std::cout << "Bureaucrat: " << this->_name << " executed " << obj.getName() << std::endl;
    }
    catch(const AForm::FormNotSignedException& e)
    {
        std::cout << "Bureaucrat: " << this->_name << " couldn't execute " << obj.getName() << " because " << e.what() << std::endl;
    }
    catch(const AForm::GradeTooLowException& e)
    {
        std::cout << "Bureaucrat: " << this->_name << " couldn't execute " << obj.getName() << " because " << e.what() << std::endl;
