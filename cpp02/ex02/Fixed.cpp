...
/*   Updated: 2025/03/17 17:49:04 by jmenard          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Fixed Fixed::operator+(Fixed const &other) const
{
    ...
    to_return.setRawBits(getRawBits() + other.getRawBits());
    return (to_return);
}
...
Fixed Fixed::operator*(Fixed const &other) const
{
    ...
    to_return.setRawBits(getRawBits() * other.getRawBits() >> bits);
    return (to_return);
}
...
{
    return (Fixed::min(nbr1, nbr2));
}

Fixed const &max(Fixed const &nbr1, Fixed const &nbr2)
{
    return (Fixed::max(nbr1, nbr2));
}